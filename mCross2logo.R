...
if ( !is.null(opt$help) | is.null(opt$file) | is.null(opt$plotfile))
{
  cat (
    ...
    ' -o, plot file name     Plot file name without extension(For example:/home/tmp/RBFOX2)\n',
    '[options]\n',
...
if(plotformat == "pdf"){
  pdf(plotfile)
  plotMotifwithCL(motif.info, col=barplot.col, border=barplot.border) #, space=barplot.space)
  invisible(dev.off())
	#dev.off()
